...
public class Parser {
	...
	public String symbol(){
		String substr = "";
		if(commandType().toString().equals("A_COMMAND")){
			if(currentCommand.charAt(0) == '@')
				substr = currentCommand.substring(1);
		}else if(commandType().toString().equals("L_COMMAND")){
	 ...
	 * @param str
	 * @return string
	 * if there are line comments than ignore them.
	 */
	...
	public String comp(){
		...
		if(currentCommand.indexOf('=') != -1  ){
			...
			composite = removeComments(composite);
